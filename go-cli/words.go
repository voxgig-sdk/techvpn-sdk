...
func registerSDKWords(r *eng.Registry, client *sdk.TechvpnSDK) {
...
func runOp(client *sdk.TechvpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
