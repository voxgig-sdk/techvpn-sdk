...
// Techvpn SDK utility: fetcher

class TechvpnFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TechvpnSDK/1.0)';
    ...
    public static function call(TechvpnContext $ctx, string $fullurl, array $fetchdef): array
    {
