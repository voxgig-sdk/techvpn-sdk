...
class TechvpnGraphql
{
    ...
    // equivalent.
    public static function body(TechvpnContext $ctx): mixed
    {
    ...
    public static function errors(TechvpnContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
