...
class TechvpnCacheFeature extends TechvpnBaseFeature
{
    ...
    private function _through(TechvpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
