...
class TechvpnStreamingFeature extends TechvpnBaseFeature
{
    ...
    private function _iterate(TechvpnResult $result): \Generator
    {
    ...
    private function _streamable(TechvpnContext $ctx): bool
    {
