...
class TechvpnRbacFeature extends TechvpnBaseFeature
{
    ...
    private function _required(TechvpnContext $ctx): ?string
    {
    ...
    private function _reject(TechvpnContext $ctx, string $required): void
    {
    ...
    private function _track(TechvpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
