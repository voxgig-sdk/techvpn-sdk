...
class TechvpnTimeoutFeature extends TechvpnBaseFeature
{
    ...
    private function _with_timeout(TechvpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TechvpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
