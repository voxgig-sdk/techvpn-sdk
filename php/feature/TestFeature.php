...
// Techvpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TechvpnTestFeature extends TechvpnBaseFeature
{
    ...
    public function init(TechvpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TechvpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TechvpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TechvpnContext $ctx, $op, $args): array
    {
