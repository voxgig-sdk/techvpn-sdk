...
class TechvpnTestRunner
{
    ...
    {
        $live = self::getenv('TECHVPN_TEST_LIVE');
        $override = self::getenv('TECHVPN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TECHVPN_TEST_EXPLAIN');
...
class_alias('TechvpnTestRunner', 'Runner');
class_alias('TechvpnHelpers', 'Helpers');
