...
// Techvpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TechvpnSDK::test)
...
{
    private const SDK_CLASS = 'TechvpnSDK';
    ...
    private const SDK_BASE = 'techvpn_sdk';
