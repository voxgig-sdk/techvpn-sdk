...
func registerTools(server *mcp.Server, client *sdk.TechvpnSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "techvpn_list",
		Description: "List records from Techvpn. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "techvpn_load",
		Description: "Load a single record from Techvpn. " +
...
func runOp(client *sdk.TechvpnSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TechvpnSDK, name string) (sdk.TechvpnEntity, error) {
