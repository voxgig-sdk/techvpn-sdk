...
// Techvpn SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TechvpnMakeRequest
{
    public static function call(TechvpnContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TechvpnResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TechvpnResponse($fetched);
        } else {
