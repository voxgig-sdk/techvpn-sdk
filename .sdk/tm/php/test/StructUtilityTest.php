...
// Techvpn SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TechvpnOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TechvpnOmni::structfix($now, Struct::undef()))
                        !== json_encode(TechvpnOmni::structfix($val, Struct::undef()))) {
