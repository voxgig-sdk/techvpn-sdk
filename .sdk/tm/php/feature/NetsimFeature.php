...
class TechvpnNetsimFeature extends TechvpnBaseFeature
{
    ...
    private function _simulate(TechvpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TechvpnContext $ctx, array $applied): void
    {
        $client = $this->client;
