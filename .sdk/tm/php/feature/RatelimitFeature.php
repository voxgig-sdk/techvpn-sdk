...
class TechvpnRatelimitFeature extends TechvpnBaseFeature
{
    ...
    private function _acquire(TechvpnContext $ctx): void
    {
    ...
    private function _track(TechvpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
