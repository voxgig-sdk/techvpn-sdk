...
class TechvpnProxyFeature extends TechvpnBaseFeature
{
    ...
    public function init(TechvpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TechvpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
