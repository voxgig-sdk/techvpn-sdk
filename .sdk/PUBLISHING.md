...
|---|---|---|
| `ts/` | @voxgig-sdk/techvpn-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/techvpn-sdk \
      --repository voxgig-sdk/techvpn-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/techvpn-sdk` shows it, and
`npm trust revoke @voxgig-sdk/techvpn-sdk --id=<id>` removes it.
