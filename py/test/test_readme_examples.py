# Techvpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TechvpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TechvpnSDK(...) and TechvpnSDK.test(...) become
#      TechvpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "techvpn_sdk"
_SDK_CLASS = "TechvpnSDK"
