...
from techvpn_sdk.core.response import TechvpnResponse
from techvpn_sdk.core.operation import TechvpnOperation
from techvpn_sdk.core.error import TechvpnError
from techvpn_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TechvpnSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TechvpnSDK.test(None, None)
        ...
        class TestInitFeature(TechvpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TechvpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TechvpnSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TechvpnSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TechvpnSDK.test(None, setup_opts)
