...
from techvpn_sdk.utility import register

# Load features
from techvpn_sdk.feature.base_feature import TechvpnBaseFeature
from techvpn_sdk.features import _has_feature, _make_feature
...
class TechvpnSDK:
    ...
    def get_utility(self):
        return TechvpnUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TechvpnSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Server(self, data=None) -> "ServerEntity":
        ...
        from techvpn_sdk.entity.server_entity import ServerEntity
        return ServerEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "TechvpnSDK":
        if sdkopts is None:
            sdkopts = {}
