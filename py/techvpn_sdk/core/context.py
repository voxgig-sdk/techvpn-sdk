...
from techvpn_sdk.core.helpers import get_ctx_prop, to_map
...
class TechvpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TechvpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TechvpnError(code, msg, self)
