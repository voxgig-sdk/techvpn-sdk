...
module TechvpnTestRunner
  ...
  def self.env_override(m)
    live = getenv("TECHVPN_TEST_LIVE")
    override = getenv("TECHVPN_TEST_OVERRIDE")
    ...
    explain = getenv("TECHVPN_TEST_EXPLAIN")
    m["TECHVPN_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = TechvpnTestRunner
Helpers = TechvpnHelpers
Vs = VoxgigStruct
