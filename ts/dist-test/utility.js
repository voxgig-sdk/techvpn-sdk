...
function envOverride(m) {
    if ('TRUE' === process.env.TECHVPN_TEST_LIVE ||
        'TRUE' === process.env.TECHVPN_TEST_OVERRIDE) {
    ...
    m.TECHVPN_TEST_EXPLAIN = process.env.TECHVPN_TEST_EXPLAIN || m.TECHVPN_TEST_EXPLAIN;
    return m;
}
