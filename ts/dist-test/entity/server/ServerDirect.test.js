...
(0, node_test_1.describe)('ServerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-server', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-server', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TECHVPN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TechvpnSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TECHVPN_TEST_SERVER_ENTID'];
    ...
    const client = new __1.TechvpnSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ServerDirect.test.js.map