...
describe('exists', async () => {
  ...
  //
  // TechvpnSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof TechvpnSDK, true,
      'TechvpnSDK.test() must return a client synchronously')
  })
