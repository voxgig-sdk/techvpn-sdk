...
describe("ServerDirect", function()
  it("should direct-list-server", function()
    local setup = server_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-server", setup.live and "live" or "unit")
...
function server_direct_setup(mockres)
